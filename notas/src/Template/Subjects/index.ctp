    ...
    <li class="heading"><?= __('Menu') ?></li>
        ...
        <li><a href="/notas/courses/">Gestionar Cursos</a></li>
          <li><a href="/notas/subjects">Gestionar Asignaturas</a></li>
           <li><?= $this->Html->link(__('-- Nueva Asignatura'), ['action' => 'add']) ?></li>
            <li><a href="/notas/SubjectMangements/add">-- Asignatura-Profesor-Dpt</a></li>
    ...
    <?php foreach ($rols as $rols): ?>
        ...
        <tr>
            ...
            <td  style="text-align:center;">
                <?= $this->Html->Link('Editar',['action'=>'edit',$rols->cod_subject],['class' => 'btn btn-primary']) ?>
                <?= $this->Form->postLink('Borrar',['action'=>'delete',$rols->cod_subject],
                                 ['class' => 'btn btn-danger','confirm' => 'Estas seguro que quiere eliminar la asignatura ' . $rols->desc_subject . '?']) ?>
